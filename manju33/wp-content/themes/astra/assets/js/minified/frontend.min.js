...
! function() {
    ...
    for (var t, a, o, r = function() {
        ...
        }, v = (r(), AstraToggleSubMenu = function(e) {
            e.preventDefault();
            ...
            if ("undefined" != typeof astraAddon) astraToggleSetupPro(d, u, i);
            else {
                var e, t, a, n = !1;
